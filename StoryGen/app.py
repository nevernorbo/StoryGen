...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.home_frame = HomeFrame(
            master=self, fg_color="transparent", corner_radius=0
        )

        # create previous generations frame
        self.previous_generations_frame = PreviousGenerationsFrame(
            master=self, fg_color="transparent", corner_radius=0
        )
        ...
        self.navigation_frame = NavigationFrame(
            ...
            previous_generations_frame=self.previous_generations_frame,
