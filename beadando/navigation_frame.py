...
class NavigationFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, master, home_frame, previous_generations_frame, key_frame, **kwargs):
        ...
        image_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "app_images")
        ...
        self.chat_image = customtkinter.CTkImage(
            ...
            dark_image=Image.open(os.path.join(image_path, "paint_brush_dark.png")), size=(22, 22))
        self.add_user_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "key_light.png")),
                                                     dark_image=Image.open(os.path.join(image_path, "key_dark.png")),
                                                     size=(22, 22))

        self.navigation_frame_label = customtkinter.CTkLabel(self, text="  StoryGen", image=self.logo_image,
                                                             compound="left",
        ...
        self.previous_generations_button = customtkinter.CTkButton(self, corner_radius=0, height=40, border_spacing=10,
        ...
        self.key_button = customtkinter.CTkButton(self, corner_radius=0, height=40, border_spacing=10, text="API key",
                                                  fg_color="transparent", text_color=("gray10", "gray90"),
                                                  hover_color=("gray70", "gray30"),
                                                  image=self.add_user_image, anchor="w", command=self.key_button_event)
    ...
    def select_frame_by_name(self, name):
        ...
        self.previous_generations_button.configure(
            fg_color=("gray75", "gray25") if name == "previous_generations" else "transparent")
        self.key_button.configure(fg_color=("gray75", "gray25") if name == "key" else "transparent")
